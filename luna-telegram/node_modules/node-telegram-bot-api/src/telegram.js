...
class TelegramBot extends EventEmitter {
  ...
  _request(_path, options = {}) {
    ...
    return request(options)
      .then(resp => {
        ...
        // TODO: why can't we do `error instanceof errors.BaseError`? id:178
  ...
  _formatSendData(type, data, fileOptions = {}) {
    ...
    // TODO: Add missing file extension. id:90
  ...
  downloadFile(fileId, downloadDir, form = {}) {
    ...
    fileStream.on('info', (info) => {
      ...
      // TODO: Ensure fileName doesn't contains slashes id:203
